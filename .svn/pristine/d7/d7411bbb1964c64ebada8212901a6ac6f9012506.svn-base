...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        ...
        ArrayList<ArrivalBoard> listArrivalBoard = new ArrayList<>();
        // For each arrival board... //
        Iterator<ArrivalBoard> iterator = selectedStation.iterator();
        // Add arrival board to list of arrival boards! //
        while (iterator.hasNext()) { listArrivalBoard.add(iterator.next()); }
        // Return list of arrival boards!/
        return listArrivalBoard;
    }
